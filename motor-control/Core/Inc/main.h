...
#define P3_L_Pin LL_GPIO_PIN_15
#define P3_L_GPIO_Port GPIOB
#define LED_STATUS_Pin LL_GPIO_PIN_6
#define LED_STATUS_GPIO_Port GPIOC
#define P1_H_Pin LL_GPIO_PIN_8
#define P1_H_GPIO_Port GPIOA
#define P2_H_Pin LL_GPIO_PIN_9
#define P2_H_GPIO_Port GPIOA
#define P3_H_Pin LL_GPIO_PIN_10
#define P3_H_GPIO_Port GPIOA
#define P2_L_Pin LL_GPIO_PIN_12
#define P2_L_GPIO_Port GPIOA
